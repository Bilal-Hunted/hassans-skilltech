        ...
        form.addEventListener('submit', function(e) {
            ...
            .then(data => {
                ...
                if (data.status === 'success') {
                    ...
                    formMessage.innerHTML = '<strong>✅ Thank You!</strong> ' + data.message;
                    form.reset();
            ...
            .catch(error => {
                formMessage.style.display = 'block';
                formMessage.className = 'form-message error';
                formMessage.innerHTML = '<strong>❌ Error!</strong> Something went wrong. Please try again or call us directly.';
            })
            .finally(() => {
